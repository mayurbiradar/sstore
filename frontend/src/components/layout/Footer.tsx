    ...
    <footer className="border-t border-slate-200 bg-white text-slate-600">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm leading-6">
            Thoughtful products for everyday living, delivered with care.
          </p>
          <a
            ...
            aria-label="Follow SStore on Instagram"
          >
        ...
        <div>
          ...
          <div className="mt-3 grid gap-2 text-sm">
            ...
            <Link to="/about" className="hover:text-rose-600">About SStore</Link>
        ...
        <div>
          ...
          <div className="mt-4 flex items-center gap-2 text-xs font-semibold text-slate-500">
            ...
            <span>UPI · Card · Net banking · COD</span>
          </div>
        </div>
      </div>
      <div className="border-t border-slate-200">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-5 text-xs text-slate-400 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          <span>© {new Date().getFullYear()} SStore. All rights reserved.</span>
