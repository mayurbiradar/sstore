...
mkcert \
    ...
    app.sstore.local api.sstore.local auth.sstore.local prometheus.sstore.local grafana.sstore.local jaeger.sstore.local argocd.sstore.local "*.sstore.local"

for hostname in app.sstore.local api.sstore.local auth.sstore.local prometheus.sstore.local grafana.sstore.local jaeger.sstore.local argocd.sstore.local; do
