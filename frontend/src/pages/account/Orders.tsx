      ...
      <div className="mx-auto max-w-5xl">
        ...
        {!loading && !error && orders.length > 0 && <>
          <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
            ...
            <Summary label="Total spent" value={formatPrice(totalSpend)} />
          </div>
