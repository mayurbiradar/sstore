...
/**
 * Spring Boot 4 / Spring Kafka 4 dropped auto-registration of the default
 * ConsumerFactory, kafkaListenerContainerFactory, ProducerFactory, and
 * KafkaTemplate. We declare them explicitly here so {@code @KafkaListener}
 * and the transactional outbox both work.
 */
@Configuration
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory(KafkaClientProperties props) {
        ...
        cfg.put(JsonDeserializer.VALUE_DEFAULT_TYPE,
                "com.sstore.order.kafka.PaymentEvent");
    ...
    public static class KafkaClientProperties {
        ...
        public static class Consumer {
            private String groupId = "order-service";
